...
public class P02AutomationExerciseSteps {
    ...
    //https://www.automationexercise.com/
        ...
        P02AutoExerciseHomePage autoExPage = new P02AutoExerciseHomePage();
        ...
        public void fill_details_title_name_email_password_date_of_birth() {
            actions.click(autoExPage.titleMrRadioButton)
        ...
        public void select_checkbox_receive_special_offers_from_our_partners() {
            actions.click(autoExPage.specialOffersCheckbox).sendKeys(Keys.TAB).perform();
        }
        ...
        public void verify_that_account_created_is_visible() {
            Assert.assertTrue(autoExPage.accountCreatedTextBox.isDisplayed());
        }

        @Given("Click Continue button")
        public void click_continue_button() {
            autoExPage.accountCreatedContinueButton.click();
        }
